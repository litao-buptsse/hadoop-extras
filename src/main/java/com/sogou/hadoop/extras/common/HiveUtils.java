...
public class HiveUtils {
  ...
  public static boolean dropPartition(String dbName, String tableName,
                                      List<String> values, boolean deleteData) throws TException {
    HiveMetaStoreClient client = null;
    try {
      client = createHiveMetaStoreClient(hiveConf);
      return client.dropPartition(dbName, tableName, values, deleteData);
    } finally {
      closeHiveMetaStoreClient(client);
    }
  }
  ...
  public static boolean dropPartition(String dbName, String tableName,
    ...
    return dropPartition(dbName, tableName, values, false);
  }
  ...
  public static String getLocation(String dbName, String tableName,
                                   List<String> values) throws TException {
    HiveMetaStoreClient client = null;
    try {
      client = createHiveMetaStoreClient(hiveConf);
      return client.getPartition(dbName, tableName, values).getSd().getLocation();
    } finally {
      closeHiveMetaStoreClient(client);
    }
  }
